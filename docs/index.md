...
English | [Русский](docs/README_RU.md) | [中文](docs/README_ZH.md)
...
Detailed internal documentation, IPC schemas, and attack engine logic can be found in [SORA Architecture v4.4](SORA_architecture_v4_4.md). For information on wireless auditing standards and regulatory compliance, see [Compliance & Standards](docs/COMPLIANCE.md).

---

## ⚖️ Licensing

- **Core & Python Layer**: [GNU GPL v3](LICENSE).
- **Plugins**: [MIT](plugins/LICENSE) — full freedom for your extensions.

---

*Created for research purposes by the Spinty.*
