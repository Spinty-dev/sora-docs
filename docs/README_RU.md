...
Подробное описание внутреннего устройства, схем IPC и логики движков доступно в [SORA Architecture v4.4](../SORA_architecture_v4_4.md). Информация о соответствии стандартам аудита и нормативным требованиям представлена в [Compliance & Standards](COMPLIANCE.md).

---

## ⚖️ Лицензирование

- **Ядро и Python-слой**: [GNU GPL v3](../LICENSE).
