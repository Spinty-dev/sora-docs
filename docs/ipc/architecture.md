...
Для системного планирования ниже приведены предельные показатели производительности IPC-моста на типичном оборудовании.

| Платформа | Max PPS (Packets Per Second) | RAM Baseline | RAM (1000 clients) |
| :--- | :--- | :--- | :--- |
| **Raspberry Pi 4 (4GB)** | ~8,500 | 45 MB | 110 MB |
| **Orange Pi 5 (RK3588)** | ~14,000 | 45 MB | 105 MB |
| **x86_64 (Core i7-12th)** | **~28,000** | 42 MB | 90 MB |

- **PPS Bottleneck**: Основное ограничение — маршалинг PyO3 и захват GIL при передаче в Python.
- **RAM Bottleneck**: Основной потребитель памяти — `DataTable` в TUI и кэш биконов в `AttackController`.
